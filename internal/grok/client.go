...
{"lambda_home":数字,"lambda_away":数字,"headline":"不超过22字","pattern":"20-40字比赛格局","plain_talk":"220-320字专业解盘","pick_1x2":"胜或平或负","pick_ou":"大或小","pick_handicap":"让胜或让平或让负或放弃","scores":["情景比分1","情景比分2"],"verdict":"主推或谨慎或放弃","buy_talk":"70-120字参考买入，明确主方向、次方向、触发条件和风险边界"}
...
只输出 JSON：
{"lambda_home":数字,"lambda_away":数字,"headline":"不超过22字","pattern":"20-40字比赛格局","plain_talk":"220-340字专业解盘","pick_1x2":"胜|平|负","pick_ou":"大|小","pick_handicap":"让胜|让平|让负|放弃","scores":["情景比分1","情景比分2"],"verdict":"主推|谨慎|放弃","buy_talk":"70-120字参考买入，明确主方向、次方向、触发条件和风险边界"}
硬性规定：
...
- 主推必须同时有盘口、人员或价值依据；拿不准写谨慎或放弃。禁止写可看或关注。谨慎表示可以留意，不是建议现在买。
